...
<section>
    ...
    <nav class="navbar mb-3 py-3 bg-dark text-light shadow">
        ...
        <div class="container text-center text-uppercase d-block">
            ...
            <div class="h5 lh-1">desa salamnunggal</div>
        ...
        <div class="row mx-auto">
            <div class="col-9">
                <div id="videoCarousel" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner" style="max-height:310px;">
                        ...
                        <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                            <img src="{{ asset('storage/' . $gallery->gallery_path) }}" class="d-block rounded w-100">
                        </div>
                        {{-- @else
